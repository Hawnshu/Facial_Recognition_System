...
# Departhment
        ...
        dep_label = Label(CC_frame, text="Department :", font=(
            "coolvetica", 12, "bold"), bg="white", justify=LEFT)
        dep_label.grid(row=0, column=0, padx=10)

        dep_combo = ttk.Combobox(CC_frame, textvariable=self.var_dep, font=(
            "Times New Roman", 10, "bold"), width=20, state="readonly")
...
# Course
        ...
        course_label = Label(CC_frame, text="Course :", font=(
            "coolvetica", 12, "bold"), bg="white", justify=LEFT)
        course_label.grid(row=0, column=2, padx=10)

        course_combo = ttk.Combobox(CC_frame, textvariable=self.var_course, font=(
            "Times New Roman", 10, "bold"), width=20, state="readonly")
...
# Year
        ...
        year_label = Label(CC_frame, text="Year :", font=(
            "coolvetica", 12, "bold"), bg="white", justify=LEFT)
        year_label.grid(row=1, column=0, padx=10)

        year_combo = ttk.Combobox(CC_frame, textvariable=self.var_year, font=(
            "Times New Roman", 10, "bold"), width=20, state="readonly")
...
# Semester
        ...
        semester_label = Label(CC_frame, text="Semester :", font=(
            "coolvetica", 12, "bold"), bg="white", justify=LEFT)
        semester_label.grid(row=1, column=2, padx=10)

        semester_combo = ttk.Combobox(CC_frame, textvariable=self.var_semester, font=(
            "Times New Roman", 10, "bold"), width=20, state="readonly")
...
# Student ID
        ...
        studentID_label = Label(CS_frame, text="Student ID :", font=(
            "coolvetica", 12, "bold"), bg="white")
        studentID_label.grid(row=0, column=0, padx=10, pady=10, sticky=W)

        studentID_entry = ttk.Entry(
            CS_frame, textvariable=self.var_std_id, width=20, font=("coolvetica", 12, "bold"))
        studentID_entry.grid(row=0, column=1, padx=10, pady=5, sticky=W)

# Student Name

        studentName_label = Label(CS_frame, text="Student Name :", font=(
            "coolvetica", 12, "bold"), bg="white")
        studentName_label.grid(row=0, column=2, padx=10, pady=5, sticky=W)

        studentName_entry = ttk.Entry(
            CS_frame, textvariable=self.var_std_name, width=20, font=("coolvetica", 12, "bold"))
        studentName_entry.grid(row=0, column=3, padx=10, pady=5, sticky=W)


# Class Division

        class_div_label = Label(CS_frame, text="Class Division :", font=(
            "coolvetica", 12, "bold"), bg="white")
        ...
        div_combo = ttk.Combobox(CS_frame, textvariable=self.var_div, font=(
            "Times New Roman", 10, "bold"), width=20, state="readonly")
...
# Roll No.
        ...
        roll_no_label = Label(CS_frame, text="Roll No :", font=(
            "coolvetica", 12, "bold"), bg="white")
        roll_no_label.grid(row=1, column=2, padx=10, pady=5, sticky=W)

        roll_no_entry = ttk.Entry(
            CS_frame, textvariable=self.var_roll, width=20, font=("coolvetica", 12, "bold"))
        roll_no_entry.grid(row=1, column=3, padx=10, pady=5, sticky=W)


# Gender

        gender_div_label = Label(CS_frame, text="Gender :", font=(
            "coolvetica", 12, "bold"), bg="white")
        ...
        gender_combo = ttk.Combobox(CS_frame, textvariable=self.var_gender, font=(
...
# Date Of Birth
        ...
        dob_label = Label(CS_frame, text="DOB :", font=(
            "coolvetica", 12, "bold"), bg="white")
        dob_label.grid(row=2, column=2, padx=10, pady=5, sticky=W)

        dob_entry = ttk.Entry(
            CS_frame, textvariable=self.var_dob, width=20, font=("coolvetica", 12, "bold"))
        dob_entry.grid(row=2, column=3, padx=10, pady=10, sticky=W)


# Email

        email_label = Label(CS_frame, text="Email :", font=(
            "coolvetica", 12, "bold"), bg="white")
        email_label.grid(row=3, column=0, padx=10, pady=5, sticky=W)

        email_entry = ttk.Entry(
            CS_frame, textvariable=self.var_email, width=20, font=("coolvetica", 12, "bold"))
        email_entry.grid(row=3, column=1, padx=10, pady=5, sticky=W)

# Phone No.

        phone_no_label = Label(CS_frame, text="Phone No :", font=(
            "coolvetica", 12, "bold"), bg="white")
        phone_no_label.grid(row=3, column=2, padx=10, pady=5, sticky=W)

        phone_no_entry = ttk.Entry(
            CS_frame, textvariable=self.var_phone, width=20, font=("coolvetica", 12, "bold"))
        phone_no_entry.grid(row=3, column=3, padx=10, pady=5, sticky=W)

# Address

        address_label = Label(CS_frame, text="Address :", font=(
            "coolvetica", 12, "bold"), bg="white")
        address_label.grid(row=4, column=0, padx=10, pady=5, sticky=W)

        address_entry = ttk.Entry(
            CS_frame, textvariable=self.var_address, width=20, font=("coolvetica", 12, "bold"))
        address_entry.grid(row=4, column=1, padx=10, pady=10, sticky=W)

# Teacher's Name

        teacher_label = Label(CS_frame, text="Teacher's Name :", font=(
            "coolvetica", 12, "bold"), bg="white")
        teacher_label.grid(row=4, column=2, padx=10, pady=5, sticky=W)

        teacher_entry = ttk.Entry(
            CS_frame, textvariable=self.var_teacher, width=20, font=("coolvetica", 12, "bold"))
...
# Radio Buttons
        ...
        radiobtn1 = ttk.Radiobutton(
            CS_frame, variable=self.var_radio1, text="Take Photo Sample", value="Yes")
        radiobtn1.grid(row=6, column=0)

        radiobtn2 = ttk.Radiobutton(
            CS_frame, variable=self.var_radio1, text="No Photo Sample", value="No")
...
# Take Photo Sample Button
        take_photo_btn = Button(btn_frame2, command=self.generate_dataset, text="Take Photo Sample", width=35, font=(
            "coolvetica", 12, "bold"), bg="blue", fg="white")
        take_photo_btn.grid(row=0, column=0)

# Update Photo Sample Button
        update_photo_btn = Button(btn_frame2, text="Update Photo Sample", width=35, font=(
            "coolvetica", 12, "bold"), bg="blue", fg="white")
...
# >>>>>>>>>>>Search System<<<<<<<<<<<<<
        ...
        search_label = Label(Search_frame, text="Search By :", font=(
            "coolvetica", 12, "bold"), bg="red", fg="white")
        ...
        search_entry = ttk.Entry(
            Search_frame, width=15, font=("coolvetica", 12, "bold"))
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                my_cursor.execute("insert into face_recognizer.student values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                                  (self.var_dep.get(),
                                   self.var_course.get(),
                                   self.var_year.get(),
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(
                        host="localhost", username="root", password="Admin@123", database="face_recognizer")
                    my_cursor = conn.cursor()
                    my_cursor.execute("Update face_recognizer.student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s", (
